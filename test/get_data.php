<?php
	...
	$questionsQuery = "SELECT question_id,question,question_type,question_image,question_extras FROM question WHERE test_id = $test_id ORDER BY RAND() LIMIT $number_of_questions";
